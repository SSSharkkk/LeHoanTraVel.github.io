...
<head>
    ...
    <link  rel="icon" type="image/x-icon" href="{{asset('public/fontend/images/logolehoan.png')}}" />
    ...
    <link rel="stylesheet" href="{{asset('public/fontend/css/magnific-popup.css')}}" type="text/css">
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="language-bar">
            <div class="language-option">
                <img src="{{asset('public/fontend/images/flag.png')}}" alt="">
        ...
        <nav class="main-menu">
            <ul>
                ...
                <li><a href="{{URL::to('/about-me')}}">Giới Thiệu</a></li>
                <li><a href="./about-us.html">Vị Trí</a></li>
                <li><a href="{{URl::to('/blog')}}">Báo Mới</a></li>
            </ul>
        </nav>
        <div class="nav-logo-right">
            <ul>
                ...
                <li>
                    ...
                    <div class="info-text">
                        <span>Email:</span>
                        <p>xedulichgiaredn43@gmail.com</p>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="nav-logo">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="logo">
                            <a href="{{URL::to('/')}}"><img src="{{asset('public/fontend/images/logolehoan.png')}}"  height="50" width="70" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div class="nav-logo-right">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="info-text">
                                        <span>Address:</span>
                                        <p>03 Hà Bổng <span>Đà Nẵng</span></p>
                                    </div>
                                </li>
                                <li>
                                    <i class="icon_mail"></i>
    ...
    <!-- Header End -->
        ...
        {{-- <div class="thumbnail-pic">
            <div class="thumbs owl-carousel">
                <div class="item">
                    <img src="{{asset('fontend/images/dot-1.jp')}}g" alt="">
                </div>
                <div class="item">
                    <img src="{{asset('fontend/images/dot-2.jpg')}}" alt="">
                </div>
                <div class="item">
                    <img src="{{asset('fontend/images/dot-3.jpg')}}" alt="">
                </div>
            </div>
        </div> --}}
    </section>
    ...
    <footer class="footer-section set-bg" data-setbg="{{asset('public/fontend/images/footer-bg.jpg')}}">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="footer-logo">
                            <div class="logo">
                                <a href="#"><img src="{{asset('public/fontend/images/logolehoan.png')}}" height="100" alt=""></a>
                            </div>
                            <p>Mang đến sự phục vụ uy tín – chất lượng – chuyên nghiệp hàng đầu tại Việt Nam.</p>
                            <p>Tin cậy, tôn trọng khách hàng và nhà đầu tư, đối tác.</p>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="footer-widget">
                            <h4>Dự Án</h4>
                            <ul>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Đà Nẵng</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Hải Châu</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Quãng Nam</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Thanh Khê</a></li>
                            </ul>
                            <ul>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Sơn Trà</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Liên Chiểu</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Ngũ Hành Sơn</a></li>
                                <li><i class="fa fa-caret-right"></i> <a href="{{URL::to('/trang-chu')}}">Cẩm Lệ</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="footer-widget">
                            <h4>SOCIAL</h4>
                            <ul class="social">
                                <li><i class="ti-facebook"></i> <a href="https://www.facebook.com/nhaptengi">Facebook</a></li>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-widget">
                            ...
                            <ul class="contact-option">
                                <li><i class="fa fa-map-marker"></i> 03 / Hà Bổng , Đà Nẵng</li>
                                <li><i class="fa fa-phone"></i> 0905414342</li>
                                <li><i class="fa fa-envelope"></i> xedulichgiaredn43@gmail.com</li>
                                <li><i class="fa fa-clock-o"></i> 24 Giờ</li>
                            </ul>
                        </div>
                    </div>
                </div>
  ...
  Website &copy;<script>document.write(new Date().getFullYear());</script> Chuyên lái xe du lịch <i class="ti-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/nhaptengi" target="_blank">Lê Hoàn</a>
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></p>
    ...
    <script src="{{asset('public/fontend/js/jquery.magnific-popup.min.js')}}"></script>
